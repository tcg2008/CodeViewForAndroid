...
public class ParserRuleSet
{
	...
	public List<ParserRule> getRules(Character key)
	{
		...
		Character upperKey = key == null ? null
				: Character.valueOf(Character.toUpperCase(key.charValue()));
		List<ParserRule> rulesForKey = upperKey == null ? null
				: ruleMap.get(upperKey);
