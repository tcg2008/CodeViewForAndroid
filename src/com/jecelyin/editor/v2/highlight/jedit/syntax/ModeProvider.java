...
public class ModeProvider
{
	 ...
	 *
	 * @param filepath
	 *            the filepath, can be {@code null}
	 * @param filename
	 *            the filename, can be {@code null}
	 * @param firstLine
	 *            the first line of the file
	 * @return the edit mode, or null if no mode match the file
	 * @since jEdit 4.5pre1
	 */
	public Mode getModeForFile(String filepath, String filename,
			String firstLine)
	{
	...
	public void loadMode(Mode mode, XModeHandler xmh)
	{
		...
		// fix Can't create default XMLReader; is system property
		...
		// ModeProvider.class.getResourceAsStream(fileName);
		// if (resource == null)
		// error(fileName, e1);
