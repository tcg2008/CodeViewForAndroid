...
import com.jecelyin.editor.v2.highlight.jedit.syntax.XModeHandler;
...
public class JEdit
{
	...
	/**
	 * Reloads all edit modes. User defined edit modes are loaded after global
	 * modes so that user modes supercede global modes.
	 *
	 * @since jEdit 3.2pre2
	 */
	public static void reloadModes()
	{
		...
		// FileOutputStream(userCatalog), "UTF-8"));
	...
	private static void loadModeCatalog(String path, String filename)
	{
		...
		{
			@Override
			protected Mode instantiateMode(String modeName, String file,
					String fileNameGlob, String firstLineGlob)
			{
