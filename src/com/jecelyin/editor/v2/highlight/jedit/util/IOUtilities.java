...
public class IOUtilities
{
	...
	/**
	 * Method that will close a {@link Closeable} ignoring it if it is null and
	 * ignoring exceptions.
	 *
	 * @param closeable
	...
	/**
	 * Method that will close an {@link ObjectInput} ignoring it if it is null
	...
	/**
	 * Method that will close an {@link ObjectOutput} ignoring it if it is null
	 * and ignoring exceptions.
	 *
	 * @param out
	 *            the closeable to close.
